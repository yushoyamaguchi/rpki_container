...
echo "router bgp 65003" >> $BGPD_CONF_FILE
echo " bgp router-id 10.10.10.3" >> $BGPD_CONF_FILE
echo " network 10.2.0.0/24" >> $BGPD_CONF_FILE
echo " network 10.3.0.0/24" >> $BGPD_CONF_FILE
echo " neighbor 10.3.0.2 remote-as 65001" >> $BGPD_CONF_FILE
echo " neighbor 10.3.0.2 next-hop-self" >> $BGPD_CONF_FILE
echo " neighbor 10.3.0.2 route-map setlocalpre in" >> $BGPD_CONF_FILE
echo " neighbor 10.2.0.1 remote-as 65002" >> $BGPD_CONF_FILE
echo " neighbor 10.2.0.1 next-hop-self" >> $BGPD_CONF_FILE
echo " neighbor 10.2.0.1 route-map setlocalpre in" >> $BGPD_CONF_FILE
echo "!" >> $BGPD_CONF_FILE
